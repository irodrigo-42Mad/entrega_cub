...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_set_sprite_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: irodrigo <irodrigo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/06/26 03:05:32 by irodrigo          #+#    #+#             */
/*   Updated: 2021/03/25 12:42:09 by irodrigo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	dy(t_game_draw *mygame)
{
	...
	{
		mygame->tex_x = (int)(256 * (mygame->stripe
					- (-mygame->spr_width / 2 + mygame->scrnx))
				* mygame->tx.width[4] / mygame->spr_width) / 256;
